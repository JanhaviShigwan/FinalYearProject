...
export default function MainLayout() {
    ...
    const menuItems = [
        ...
        { href: "/events", icon: <Search size={20} />, label: "Browse Events" },
        { href: "/my-registrations", icon: <ClipboardList size={20} />, label: "My Registrations" },
        { href: "/calendar", icon: <Calendar size={20} />, label: "Calendar" },
        { href: "/announcements", icon: <Megaphone size={20} />, label: "Announcements" },
