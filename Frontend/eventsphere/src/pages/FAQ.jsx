        ...
        <div className="relative z-10 max-w-3xl mx-auto space-y-4">
          {faqs.map((faq, index) => {
            ...
            return (
              <div
                key={index}
                className={`rounded-2xl transition-all duration-300 bg-white ${isOpen
              ...
              >
                ...
                {/* Answer */}
                <div
                  className={`overflow-hidden transition-all duration-300 ${isOpen ? "max-h-40 px-5 pb-5" : "max-h-0"
                    }`}
                >
